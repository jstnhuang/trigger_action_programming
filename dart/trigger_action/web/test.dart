...
void main() {
  group('toJSON', () {
    test('StatementList.toJSON common case', () {
      ...
      Statement s1 = new Statement('test id', [t1, t2], new Action('say_something', {'speech': 'hello world'}), false);
      Trigger t3 = new Trigger('person_detected', {});
      Statement s2 = new Statement('test id', [t3], new Action('say_something', {'speech': 'hello world'}), false);
    ...
    test('Statement.toJSON common case', () {
      Trigger t1 = new Trigger('person_detected', {});
      Trigger t2 = new Trigger('person_detected2', {});
      Statement s = new Statement('test id', [t1, t2], new Action('say_something', {'speech': 'hello world'}), false);
      Object expected = {
        'id': 'test id',
        'triggers': [t1, t2],
        'actions': [
